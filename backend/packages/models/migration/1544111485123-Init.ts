...
export class Init1544111485123 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "studentProfiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "studyProgram" text NOT NULL, "university" text NOT NULL, "studentId" uuid, CONSTRAINT "REL_dc67d969b66ee433ddb6825c90" UNIQUE ("studentId"), CONSTRAINT "PK_fea32f01cdb61a03ca60525cfa0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstname" text NOT NULL, "lastname" text NOT NULL, "phone" text NOT NULL, "email" citext NOT NULL, "username" citext, "password" text NOT NULL, "confirmed" boolean NOT NULL DEFAULT false, "sequenceNumber" BIGSERIAL NOT NULL, "siteAdmin" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "version" integer NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "studentProfiles" ADD CONSTRAINT "FK_dc67d969b66ee433ddb6825c90b" FOREIGN KEY ("studentId") REFERENCES "users"("id")`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "studentProfiles" DROP CONSTRAINT "FK_dc67d969b66ee433ddb6825c90b"`
    );
    await queryRunner.query(
